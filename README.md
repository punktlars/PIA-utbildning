...
**Idén** är att du ska kunna skicka vykort med hjälp av din telefon var du än är. Du laddar upp en bild, skriver ett meddelande och lägger till namn och adress (precis som på ett fysiskt vykort) på den du vill skicka till. Den som får vykortet måste själv kolla sin brevlåda (ingen notifikation) och vara vid adressen för att ta emot kortet. Vi talade till och med om att vykorten endast skulle kunna skickas från fysiska postlådor, det finns någon typ av api för det, men det täcker ju inte in varenda brevlåda i dagens globaliserade värld, så det fick bli utan.
